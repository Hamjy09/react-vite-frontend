...
const Recomend = () => {
  return (
    <div className="md:mx-5 w-[95%]">
      ...
      >
        {/* Text content */}
        <div className="text-base md:text-lg text-white mt-3 md:mt-0">
          Our Recommendation
        </div>
        <div className="text-2xl md:text-4xl mt-2 md:mt-4 text-white">
          BeWatch GT
        </div>
        <div className="text-sm md:text-lg text-white mt-1 md:mt-2">
          Dolor premium
        </div>
